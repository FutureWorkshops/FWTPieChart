...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    FWTPieChartSegmentData *firstSegment = [FWTPieChartSegmentData pieChartSegmentWithValue:@0.92f
                                                                                      color:[UIColor colorWithRed:22/255.f green:86/255.f blue:219/255.f alpha:1]
                                                                                  innerText:@"A"
                                                                               andOuterText:@"2"];
    FWTPieChartSegmentData *secondSegment = [FWTPieChartSegmentData pieChartSegmentWithValue:@0.01f
                                                                                      color:[UIColor colorWithRed:235/255.f green:81/255.f blue:29/255.f alpha:1]
                                                                                  innerText:@"B"
                                                                               andOuterText:@"4"];
    FWTPieChartSegmentData *thirdSegment = [FWTPieChartSegmentData pieChartSegmentWithValue:@0.07f
